...
<a href="https://huggingface.co/" target="_blank" rel="noreferrer"><img src="https://huggingface.co/favicon.ico" width="36" height="36" alt="Hugging Face" /></a>
...
<a href="https://cloud.google.com/bigquery/" target="_blank" rel="noreferrer"><img src="https://www.vectorlogo.zone/logos/google_bigquery/google_bigquery-icon.svg" width="36" height="36" alt="Vector DB" /></a>
...
#### Verifiable AI & LLMs
- **[Verifiable LLM on Qwen 2.5](https://github.com/shirin-shahabi/verifiable-llm)** - Led development with no overhead of computation using Multi Context Protocol sampling
- **[Agentic AI with Proof of Inference](https://github.com/shirin-shahabi/agentic-ai)** - Created the first Verifiable Agentic AI meeting legal and insurance liability requirements
- **[SR&ED Auditing Documentation Pipeline](https://github.com/shirin-shahabi/sred-pipeline)** - Automated system using Google's Flan T5, seamlessly integrating GitHub, Slack messages, and Jira

#### Trading & Optimization Systems
- **[Trading Bot with FastDQN](https://github.com/shirin-shahabi/trading-bot)** - Enhanced risk mitigation strategies outperforming human traders by 185%
- **[Transportation Optimization](https://github.com/shirin-shahabi/rail-highway-optimization)** - Multi-objective bi-strategy for West America's rail-highway transportation using Gurobi
- **[Structured Pruning for LLMs](https://github.com/shirin-shahabi/llm-pruning)** - Applied pruning and quantization techniques on 8-billion parameter LLaMA and ResNet models

#### Data Science & Analytics in Finance
- **[Customer Clustering at Scale](https://github.com/shirin-shahabi/customer-clustering)** - Processed 4+ million financial customers using Spark, increasing MAU from 4M to 8.5M
- **[Marketing Data Modeling Pipeline](https://github.com/shirin-shahabi/marketing-etl)** - End-to-end Marketing Data Modeling and ETL Pipeline using Django and ORM Design
- **[Financial KPI Dashboard](https://github.com/shirin-shahabi/financial-kpi)** - Defined +50 financial KPIs identifying company priorities for strategic growth
